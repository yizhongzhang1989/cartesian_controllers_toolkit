#!/usr/bin/env python3
"""Optional web dashboard for cct_pose_commander — a thin HTTP/ROS client.
...
Mirrors the cartesian_controller_dashboard / cct_inverse_kinematics dashboard
...
class CommanderDashboard(Node):
    def __init__(self) -> None:
        super().__init__("cct_pose_commander_dashboard")
        self.declare_parameter("port", 8180)
        self.declare_parameter("commander_ns", "/cct_pose_commander_right")
        ...
        self.get_logger().info(
            "cct_pose_commander dashboard on http://%s:%d  (commander_ns=%s, "
