...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="cct_ik",
                                 description="cct_inverse_kinematics CLI (advisory only)")
