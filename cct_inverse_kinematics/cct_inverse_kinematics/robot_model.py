...
try:
    ...
    raise ImportError(
        "cct_inverse_kinematics requires Pinocchio (python3-pinocchio). "
...
except Exception:  # pragma: no cover - cct_common always present in the toolkit
    augment_urdf = None
    ...
    def __init__(self, urdf_xml: str,
        ...
        if frames:
            if augment_urdf is None:
                raise RuntimeError(
                    "virtual_frames requested but cct_common.urdf_loader."
